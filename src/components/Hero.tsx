    ...
    return (
        <section className="relative h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
            <motion.div style={{ opacity: heroOpacity, scale: heroScale, y: heroY }} className="relative z-10">
                ...
                >
                    <Activity className="w-3 h-3 animate-pulse" /> Beyond Design: Digital Infrastructure
                </motion.div>
                ...
                >
                    INFRASTRUCTURE <br />
                    FOR <span className="italic text-[#1E90FF] drop-shadow-[0_0_20px_rgba(30,144,255,0.4)]">SCALING.</span>
                </motion.h1>
                ...
                >
                    We stop building websites. We start building <span className="text-white font-medium">Operating Systems</span> that convert cold viewers into high-ticket buyers with military precision.
                </motion.p>
                ...
                >
                    ...
                    >
                        ...
                        <span className="relative z-10 font-inter font-bold uppercase tracking-widest text-sm flex items-center gap-3 text-white">
                            {buildStatus === 'idle' && <>Deploy Entry Offer <Zap className="w-4 h-4 fill-white group-hover:scale-125 transition-transform" /></>}
